    ...
    <div className="relative min-h-screen bg-gray-50 pt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="relative w-full max-w-6xl mx-auto overflow-hidden h-[600px] lg:h-[720px]">
            {/* SVG Clip Path (organic mask) */}
            <svg viewBox="0 0 1200 650" className="absolute inset-0 w-full h-auto z-0">
              <defs>
                <clipPath id="organicClip" clipPathUnits="objectBoundingBox">
                  <path d="M0,0.08 Q0,0 0.08,0 H0.92 Q1,0 1,0.08 V0.85 Q1,0.95 0.92,1 H0.08 Q0,1 0,0.92 Z" />
                </clipPath>
              </defs>
            </svg>

            {/* Landscape background with clip path applied */}
            <div 
              className="w-full h-full object-cover rounded-[60px] shadow-2xl"
              style={{ clipPath: 'url(#organicClip)' }}
            >
              {/* Sky gradient */}
            ...
            <button
              className="absolute top-4 right-4 w-14 h-14 bg-white text-black text-2xl rounded-full flex items-center justify-center shadow-md hover:scale-110 transition-transform"
